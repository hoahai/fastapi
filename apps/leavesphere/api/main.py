...
from apps.leavesphere.api.v1.endpoints.publicGoogleCalendar import (
    router as public_google_calendar_router,
)
...
app.include_router(public_google_calendar_router)

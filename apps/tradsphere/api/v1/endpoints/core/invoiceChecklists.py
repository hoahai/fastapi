...
def sync_invoice_checklists_period_route(
    ...
    Requirements:
        ...
        - Generates expected rows from schedules where the Monday that starts each schedule week matches the selected month/year, then applies account billingType period semantics (Calendar excludes trailing overlap week; Broadcast keeps full broadcast weeks)

...
def get_active_services():
    ...
    Requirements:
        ...
        - Response is cached per tenant (default TTL 86400 seconds)
          (refreshed via /cache/refresh or when stale)
    """
    return filter_and_sort_services_with_ad_type(
        get_services(department_code="DIGM")
    )

      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {APP_NAV_ITEMS.map((app) => {
          ...
          return (
            <article
              key={app.id}
              className="group rounded-2xl border border-blue-100 bg-white/90 p-5 shadow-soft transition hover:-translate-y-0.5 hover:border-blue-300 hover:shadow-lg"
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-lg font-semibold text-slate-900">{app.label}</h2>
